    ...
    for round in range(n_comm_rounds):
        ...
        for clnt in party_list_this_round:
            ...
            for e in range(args.epochs):
                # Training
                for batch_idx, (batch_x, batch_y, batch_ind) in enumerate(train_dataloader):
        ...
        # Test            
        test_acc, f1, precision, recall, conf_matrix, avg_loss = compute_accuracy(avg_model, test_dl, get_confusion_matrix=True, device=device)
        ...
        avg_model.to('cpu')
        global_model=copy.deepcopy(avg_model)
